        ...
        instructions={
          <div className="flex flex-col gap-8">
            <p>
              ...
              spraying or antimalarial treatments. A high MOI generally
              indicates a higher transmission intensity in the community because
              a greater number of different strains are circulating and
              infecting individuals. Therefore, effective malaria control
              interventions should reduce the transmission of the parasite,
              leading to a decrease in the MOI over time.
            </p>
            <p>
            ...
            <p>
              ...
              malaria indicator survey and a functioning molecular lab. You also
              have historic data showing average MOI in this high transmission
              area was 2.5 before the vector controls intervention began
            </p>
          </div>
        }
        complete={false}
