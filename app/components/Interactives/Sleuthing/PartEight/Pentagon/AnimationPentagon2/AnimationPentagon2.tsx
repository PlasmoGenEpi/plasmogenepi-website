...
import EGMosquito2 from "../AnimationComponents/EGMosquito2";
import EIMosquito2 from "../AnimationComponents/EIMosquito2";
import FHMosquito2 from "../AnimationComponents/FHMosquito2";
...
export default function AnimationPentagon() {
  ...
  const direction = prevPhase.current < phase ? "forwards" : "backwards";

  return (
    <svg
      id="animation-pentagon"
...
"
        ...
        <symbol id="person-MOI-E" viewBox={"0 0 600 600"}>
          ...
          <circle
            ...
            cy={75}
            className={`${
              phase > 23 ? "fill-microRed" : "fill-white"
            } stroke-black `}
          ></circle>
          <circle
            r={9}
            ...
            fill="white"
            className={`${
              phase > 23 ? "fill-microBlue" : "fill-white"
            } stroke-black `}
          ></circle>
        </symbol>
        <symbol
