            ...
            {phase === 6 && (
              <div>
                <KnowledgeCheckQuestion
                  ...
                  headerText="Based on your analysis of the genotypes, do you see any evidence of direct malaria transmission (via a mosquito) between any of these children?"
                  questionIdx={2}
                />
