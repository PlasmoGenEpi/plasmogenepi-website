        ...
        <div className="flex w-full max-w-[500px] flex-col gap-1">
          ...
          <div className="relative grid gap-1 [grid-template-columns:8%_auto]">
            ...
            <button
              ...
              className={` ${!hybridCreated ? "tooltip tooltip-bottom" : "translate-x-0"}  col-start-2 mx-auto my-4 aspect-square w-fit rounded-full bg-gradient-to-r from-cloneRed via-[#FFB0B0_25%,#B8E6FA_75%] to-cloneBlue bg-blend-overlay transition-all focus:tooltip-open hover:scale-105 focus:ring-2 focus:ring-black active:scale-90 disabled:hover:scale-100`}
            >
              <Image
                alt="mosquito"
