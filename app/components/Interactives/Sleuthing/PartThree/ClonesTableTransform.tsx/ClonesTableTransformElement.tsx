...
export default function ClonesTableTransformElement({
  ...
  return (
    <button
      ...
      className={`${active ? " border-2 border-black" : "border-2 border-transparent [&>*]:opacity-40"} ${active && attempted ? "wiggle" : ""} pointer-events-auto col-span-3 grid grid-cols-3 gap-0.5 transition-all [&>*]:transition-opacity [&>*]:duration-500`}
    >
      <CloneElement
        className="bg-white"
        possibleValues={{
