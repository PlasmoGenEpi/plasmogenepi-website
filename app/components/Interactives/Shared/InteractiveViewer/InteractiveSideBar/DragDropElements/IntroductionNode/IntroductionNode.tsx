...
export default function IntroductionNode() {
  ...
  const sectionActive = currentView.section === 0;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <h4 className="col-start-2 text-sm pr-8">Goal</h4>
            <div
              className={`absolute right-4 top-1/2 h-2 w-2 -translate-y-1/2 rounded-full border-zinc-600 border
                    ${completion?.[0]?.[1] ? "bg-current" : ""}`}
            ></div>
          </button>
          <button
            onClick={() => {
