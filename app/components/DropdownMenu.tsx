...
import PrimaryNav from "./NavBar/Links/PrimaryNav";

export default function DropdownMenu({ currentNav }: { currentNav: string }) {
  const [open, setOpen] = useState(false);
  return (
    <div className=" relative md:ml-auto md:mt-auto md:h-auto md:p-2">
      <button
      ...
      <div
        className={
          open
            ? "flex h-40 flex-col overflow-hidden border-y-8 border-pge-blue bg-pge-darkest-blue bg-opacity-90 backdrop-blur-sm transition-all md:flex-row md:gap-4 md:border-0 md:bg-transparent md:py-0"
            : "flex h-0 flex-col overflow-hidden border-y-8 border-pge-blue bg-pge-darkest-blue bg-opacity-90 backdrop-blur-sm transition-all md:h-auto md:flex-row md:gap-4 md:border-0 md:bg-transparent md:py-0"
        }
      >
        <PrimaryNav
          icon_svg={
