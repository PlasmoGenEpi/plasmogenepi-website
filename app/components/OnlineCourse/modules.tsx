...
export const orderedModules = [
    ...
    content: (
      <div>
        <p className="mb-4">
          ...
          standard rapid diagnostic test, and if it will respond to antimalarial
          drugs? In this module you will explore the relationship between
          genetics and the transmission and biology of malaria, and how it can
          be used to answer these and other questions. You will also learn about
          genetic variation and how to interpret simple phenotypes from malaria
        ...
        {/* <div className="mb-4">
          ...
          <Link
            ...
            target="_blank"
            className="font-roboto font-bold text-blue-500"
  ...
  {
    title: <h3> M3 &ndash; Drug and Diagnostic Resistance</h3>,
    content: (
      <div>
        <p className="mb-4">
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <p className="mb-4">
          If you are in the <span className="font-bold">research cohort, </span>
          you will also learn how to interpret results from common genotyping
          methods, including qPCR and Sanger sequencing. Additionally, you will
          be able to explain how next generation sequencing works and what are
          common bioinformatic tools to analyze sequencing data.
        </p>
        <div className="mb-4">
          <p>Program Cohort</p>
          <ul className="pl-8">
    ...
    content: (
      <div>
        <p className="mb-4">
          ...
          design effective genetic surveillance studies. Topics study design,
          sampling, stratification, power and sample size. You will also learn
          how to critically assess the pros and cons of different approaches fto
          study design for different use cases.
        </p>
        <ul className="mb-4 pl-8">
    ...
    content: (
      <div>
        <p className="mb-4">
          ...
          choose the best way to present your findings to different stakeholder,
          and avoid common pitfalls that could lead to misinterpretation of your
          results.
        </p>
        <ul className="pl-8">
