  ...
  return (
    <div>
      ...
      <ol className="list-decimal">
        ...
        <li>
          Choose the appropriate methods to generate Genetic data for different
          use cases and settings.
        </li>
        <li>
          Choose the appropriate metrics derived from malaria Genetic data to
          answer key questions.
        </li>
        <li>
          Design Genetic surveillance studies to answer key questions about the
