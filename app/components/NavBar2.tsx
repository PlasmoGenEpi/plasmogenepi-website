    ...
    <div className="">
      <div>
        ...
        <div
          className={
            openMenu
              ? "flex h-36 flex-col items-center justify-around overflow-hidden bg-pge-blue py-2 transition-all md:hidden"
              : "pointer-events-none flex h-0 flex-col items-center justify-around overflow-hidden bg-pge-blue py-2 transition-all"
          }
        >
          <Link
            className={
              !openMenu
                ? "hidden"
                : currentNav === "OnlineCourse"
                ? "text-white flex w-full justify-center gap-4  py-2 text-center font-bold underline underline-offset-2"
                : "text-white flex w-full justify-center gap-4  py-2 text-center font-bold"
            }
            href="/OnlineCourse"
          >
            <svg
          ...
          <Link
            className={
              !openMenu
                ? "hidden"
                : currentNav === "DataStandards"
                ? "text-white flex w-full justify-center gap-2 py-2 text-center font-bold underline underline-offset-2"
                : "text-white flex w-full justify-center gap-2 py-2 text-center font-bold"
            }
            href="/DataStandards"
          >
            <svg
