  ...
  return (
    <div className="relative">
      <div
        className={
          open
            ? "border-pge-dark-teal bg-pge-darkest-teal  flex h-52 flex-col overflow-hidden border-y-8 transition-[height] duration-500 md:h-auto md:flex-row md:gap-4 md:border-0 md:bg-transparent md:py-0 md:pr-2 md:backdrop-blur-0"
            : "border-pge-dark-teal bg-pge-darkest-teal pointer-events-none flex h-0 flex-col overflow-hidden border-y-8 transition-[height] duration-500 md:pointer-events-auto md:h-auto md:flex-row md:gap-4 md:border-0 md:bg-transparent md:p-2"
        }
      >
        <div className="grid h-12 grid-cols-2 place-items-center md:flex md:h-auto md:border-b-4 md:border-transparent">
          <ThemeSwitch />
        </div>
        <PrimaryNav
          icon_svg={
