...
export default function NavBar({ currentNav }: { currentNav: string }) {
  ...
  return (
    <div className=" pt-[106px] md:pt-0">
      <div className="fixed top-0 z-50 h-[106px] w-full border-b-[16px] border-pge-blue bg-zinc-50 md:static">
        <div className="mx-auto flex max-w-6xl flex-col md:flex-row">
          <LogoLink />
          <div className=" relative md:ml-auto md:mt-auto md:h-auto md:px-2 md:py-0.5">
            {/* #333361 #3E3E3E #192950*/}
            <DropdownMenu open={open} setOpen={setOpen} />
            <div
              className={
                open
                  ? "flex h-40 flex-col overflow-hidden border-y-8 border-pge-blue bg-pge-darkest-blue bg-opacity-90 backdrop-blur-sm transition-[height] md:h-auto md:flex-row md:gap-4 md:border-0 md:bg-transparent md:py-0 md:backdrop-blur-0"
                  : "flex h-0 flex-col overflow-hidden border-y-8 border-pge-blue bg-pge-darkest-blue bg-opacity-90 backdrop-blur-sm transition-[height] md:h-auto md:flex-row md:gap-4 md:border-0 md:bg-transparent md:py-0"
              }
            >
              <PrimaryNav
                icon_svg={
