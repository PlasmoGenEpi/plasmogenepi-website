    ...
    <div
      className={
        readOneQuestions[1].oneChecked && phase === 2
          ? "absolute -top-2 left-[830px] z-[30] h-4 w-[244px] border-2 border-[#0E5258] opacity-100 transition-opacity duration-500"
          : "absolute -top-2 left-[830px] z-[30] h-4 w-[244px] border-2 border-[#0E5258] opacity-0 transition-opacity duration-500"
      }
    >
