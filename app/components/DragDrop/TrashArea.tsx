...
export default function TrashArea() {
  ...
  return (
    <div
      ...
      className={
        dragWithinTrash
          ? "absolute bottom-0 left-[320px] right-4 flex h-32 items-center justify-end border border-black bg-[#ffe5e5]"
          : "absolute bottom-0 left-[320px] right-4 flex h-32 items-center justify-end border border-black bg-white"
      }
    >
      <svg
        className="mr-2"
