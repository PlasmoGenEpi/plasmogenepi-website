...
export default function BloodSpotThumbnail({
  ...
  return (
    <button
      ...
      data-tip={tooltip}
      className={`tooltip relative mb-auto w-full max-w-[200px] select-none border-[3px] p-2 transition-all focus-visible:tooltip-open focus:outline-offset-4 ${
        className ? className : ""
    ...
    >
      ...
      <div
        className={`relative isolate flex aspect-[2/1] w-full max-w-[200px] grow origin-top-left items-center justify-center bg-gradient-to-b from-zinc-50 via-transparent to-zinc-50   shadow-sm shadow-black transition-[opacity,_transform] duration-300 md:aspect-[9/4] ${
